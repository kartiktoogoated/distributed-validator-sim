      ...
      <Tabs defaultValue="account" className="space-y-4">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">You’ll get alerts at your email</p>
                </div>
                <Switch
        ...
        <TabsContent value="monitoring">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">You’ll be able to configure intervals, regions, and more.</p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="billing">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Plans, invoices, and payment methods will appear here.</p>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
